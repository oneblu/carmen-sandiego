  ...
  <div>
    ...
    >
      <div class="flex flex-col gap-4 items-center sm:items-start justify-center sm:max-w-144">
        ...
        <p class="text-surface-700 dark:text-surface-300 text-lg text-center sm:text-start">Ready-to-use UI blocks for building beautiful applications. A comprehensive collection of components designed to speed up your development process.</p>
